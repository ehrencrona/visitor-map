...
public class MapContext extends AbstractContext {
	...
	public MapContext(File dataDirectory, boolean persist) {
		super(persist);
	...
	public synchronized static MapContext getContext() {
		if (context == null) {
			context = new MapContext(new File("/projects/recommend/accesslog/data"), true);
		}
